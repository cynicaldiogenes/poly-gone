/************************************************
Ideas for patterns:
- Single color chase with gradient
- Have pixel remember its last color
- All pulse as same color
- All pulse as current color
- Line moving from one side to other (each directino)
- Start in corner and spread to all others (or start arbitrary and spread)
************************************************/
